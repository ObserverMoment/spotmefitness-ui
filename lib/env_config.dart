...
class EnvironmentConfig {
  ...
  static String apiUrl = String.fromEnvironment('SPOTME_API_URL',
      defaultValue: 'http://${EnvironmentConfig.gethost()}:4000');
