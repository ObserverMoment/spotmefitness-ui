...
import 'package:sofie_ui/components/creators/club_creator/club_invite_token_creator.dart';
      ...
      builder: (context) => CupertinoActionSheet(
          actions: [
            CupertinoActionSheetAction(
              child: const MyText('View Profile'),
              onPressed: () async {
                context.pop();
                context
            ...
            if (authedUserId != userId)
              CupertinoActionSheetAction(
                child: const MyText('Send Message'),
                onPressed: () async {
                  context.pop();
            ...
            if (authedUserMemberType == ClubMemberType.owner &&
              ...
              CupertinoActionSheetAction(
                child: const MyText('Give Admin Status'),
                onPressed: () async {
                  context.pop();
            ...
            if (authedUserMemberType == ClubMemberType.owner &&
              ...
              CupertinoActionSheetAction(
                child: const MyText('Remove Admin Status'),
                onPressed: () async {
                  context.pop();
