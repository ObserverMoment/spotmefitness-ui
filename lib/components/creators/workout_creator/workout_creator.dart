...
import 'package:sofie_ui/components/creators/workout_creator/workout_creator_meta.dart';
  ...
  void _saveAndClose() {
    ...
    if (success) {
      ...
      context.showConfirmDialog(
          title: 'Oh dear..!',
          content: const MyText('Sorry, there was an issue saving!'),
            ...
            children: [
              AnimatedSwitcher(
                ...
                child: uploadingMedia
                    ...
                    : MyTabBarNav(
                        titles: const ['Meta', 'Structure', 'Media'],
                        handleTabChange: (i) =>
