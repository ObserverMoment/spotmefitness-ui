...
/// ```
/// {@end-tool}
/// [NOTE]: Copied from built in [CupertinoSearchTextField] to add [textInputAction: TextInputAction.search] to the underlying text field. Does not seem to default for this and no docs / issues relating?
/// + some other tweaked defaults.
class MyCupertinoSearchTextField extends StatefulWidget {
  ...
  const MyCupertinoSearchTextField({
    ...
    this.borderRadius,
    this.padding = const EdgeInsetsDirectional.fromSTEB(4, 12, 5, 10),
    this.itemColor = CupertinoColors.secondaryLabel,
    this.itemSize = 20.0,
    this.prefixInsets = const EdgeInsetsDirectional.fromSTEB(6, 6, 0, 4),
    this.suffixInsets = const EdgeInsetsDirectional.fromSTEB(0, 6, 5, 6),
  ...
  @override
  State<StatefulWidget> createState() => _MyCupertinoSearchTextFieldState();
}

class _MyCupertinoSearchTextFieldState extends State<MyCupertinoSearchTextField>
  ...
  @override
  void didUpdateWidget(MyCupertinoSearchTextField oldWidget) {
