...
// class TimecapPickerDisplay extends StatelessWidget {
//   final Duration? timecap;
//   final Function(Duration? duration) saveTimecap;

//   /// Defaults to true. Hides the on / off switch in the [TimecapPickerDisplay] if false. And will not render the widget if [timecap] is null.
...
// class TimecapPicker extends StatefulWidget {
//   final Duration? timecap;
//   final Function(Duration? duration) saveTimecap;
...
//   @override
//   _TimecapPickerState createState() => _TimecapPickerState();
// }

// class _TimecapPickerState extends State<TimecapPicker> {
