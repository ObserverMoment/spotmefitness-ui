...
class LastStandingSectionMovesList extends StatefulWidget {
  final WorkoutSection workoutSection;
  final WorkoutSectionProgressState state;
  const LastStandingSectionMovesList(
      {Key? key, required this.workoutSection, required this.state})
      : super(key: key);

  @override
  _LastStandingSectionMovesListState createState() =>
      _LastStandingSectionMovesListState();
}

class _LastStandingSectionMovesListState
    extends State<LastStandingSectionMovesList> {
  ...
  @override
  void didUpdateWidget(LastStandingSectionMovesList oldWidget) {
